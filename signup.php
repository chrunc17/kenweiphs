				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-0em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1>Create account and be <br>a great Manager!</h1>	
						</div>
...
if($password != $cpassword){
	...
	$password=$_POST['password'];
	$sql="insert into Manageraccount (email,firstname,lastname,contact_no,password) values('$email','$fname','$lname','$cnumber','$password')";
	if(mysql_query($sql))
	{
